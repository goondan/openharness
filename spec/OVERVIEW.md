...
| FR-OBS-004 | 코어가 발행하는 이벤트: turn.start, turn.done, turn.error, step.start, step.done, step.error, tool.start, tool.done, tool.error, ingress.received, ingress.accepted, ingress.rejected. | G-1 |
